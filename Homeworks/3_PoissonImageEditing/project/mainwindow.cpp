	...
	: QMainWindow(parent)
{
	...
	mdi_area_ = new QMdiArea;//QMdiArea（Multiple Document Interface Area）提供了一个可以同时显示多个文档窗口的区域
	mdi_area_->setHorizontalScrollBarPolicy(Qt::ScrollBarAsNeeded);//设置水平滚动条
	mdi_area_->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);//设置垂直滚动条
...
void MainWindow::CreateActions()
{
	...
	// 	action_new_->setStatusTip(tr("Create a new file"));
		...
		// File IO
	action_open_ = new QAction(QIcon("C:/Users/95118/source/repos/03PoissonImageEditing/03PoissonImageEditing/images/open.jpg"), tr("&Open..."), this);
	action_open_->setShortcuts(QKeySequence::Open);
	action_open_->setStatusTip(tr("Open an existing file"));
	connect(action_open_, SIGNAL(triggered()), this, SLOT(Open()));

	action_save_ = new QAction(QIcon("C:/Users/95118/source/repos/03PoissonImageEditing/03PoissonImageEditing/images/save.jpg"), tr("&Save"), this);
