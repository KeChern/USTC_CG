...
int main()
{
    ...
    // World position and scale of the plane
    pointf3 plane_pos(0.0f, -1.0f, 0.0f);
    scalef3 plane_scale(1000.0f, 1.0f, 1000.0f);
    // Load the texture of the plane
    gl::Texture2D plane_tex = loadTexture("../data/textures/green_checkerboard.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightProjection = transformf::orthographic(20.0f, 20.0f, near_plane, far_plane);
        //Perspective Projection
        lightProjection = transformf::perspective(PI<float> / 2, (GLfloat)scr_width / (GLfloat)scr_height, near_plane, far_plane);
        
        lightView = transformf::look_at(lightPos, pointf3(1, 0, 0), vecf3(0, 1, 0));
        ...
        // draw the plane
        shadow_program.Active(0, &plane_tex);
        transformf plane_model_shadow(plane_pos, plane_scale);
        shadow_program.SetMatf4("model", plane_model_shadow);
        ...
        light_shadow_program.SetMatf4("lightSpaceMatrix", lightProjection * lightView);
        ...
        // draw the plane
        light_shadow_program.Active(0, &plane_tex);
        transformf plane_model(plane_pos, plane_scale);
